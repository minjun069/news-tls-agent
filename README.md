...
- 어떻게 만드는가 → [`docs/TECH_DESIGN.md`](docs/TECH_DESIGN.md)
...
상세는 [`docs/TECH_DESIGN.md`](docs/TECH_DESIGN.md) §4.
...
WSL에서 개발하는 경우 `MSSQL_HOST`는 `localhost`가 아니다 — `.env.example` 주석 참조.
...
각 검사가 무엇을 잡는지는 [`docs/FEEDBACK_LOOPS.md`](docs/FEEDBACK_LOOPS.md).

## 진행 상황

[`docs/ROADMAP.md`](docs/ROADMAP.md) — 현재 **S1 기반 구축**.
